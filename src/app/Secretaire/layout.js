      ...
      <body>
        <div className="w-full h-screen">
          <div className="w-[100%] h-full" style={{ display: 'flex' }}>
            <Sidebar onBackdropClick={() => setToggled(false)} toggled={toggled} breakPoint="lg">
              <Menu>
            ...
            <main className="w-[100%] h-full" style={{ display: 'flex', padding: 10 }}>
              <div className="w-full h-full">
                ...
                <div className="">
                  ...
                  <div className="w-[100%] h-[34.5rem] mt-4 overflow-y-auto bg-white rounded-md ">
                    {children}
                  </div>
                </div>
              </div>
