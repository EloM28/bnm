...
const EcritureSecretaire = () => {
  return (
        <div className='mx-auto w-[100%] h-full flex items-center bg-blue-100 justify-center'>
            <div className='w-[30%] h-[95%] flex flex-col space-y-3 bg-white rounded-md rounded-tr-2xl'>
                <div className='w-[78%] h-full flex flex-col space-y-2 mx-auto mt-2'>
                ...
                <div className='flex flex-col space-y-1 w-[23rem] mx-auto'>
                    <label htmlFor="first_name" className="text-xl font-medium text-slate-700">Numero de reference</label>
                    <input type="text" className="border border-slate-700 text-slate-700 text-lg rounded-lg block w-full p-2.5 dark:placeholder-slate-700 focus:outline-none placeholder:text-sm" required />
                </div>
