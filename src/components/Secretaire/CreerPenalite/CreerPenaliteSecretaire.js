...
const CreerPenaliteSecretaire = ({closeModal}) => {
  return (
        ...
        <span className='flex justify-center text-3xl font-bold text-slate-700 mt-5'>Creez une penalite</span>
        <div className='w-[78%] flex flex-col space-y-3 mx-auto'>
            ...
            <div className='flex flex-col space-y-2 w-full'>
            <label htmlFor="first_name" className="text-xl font-medium text-slate-700">Numero De la penalite</label>
            ...
            <div className='flex flex-col space-y-2 w-full'>
            <label htmlFor="first_name" className="text-xl font-medium text-slate-700">Client</label>
            <input type="text" className="border border-slate-700 text-slate-700 text-lg rounded-lg block w-full p-2.5 dark:placeholder-slate-700 focus:outline-none" required />
            </div>
            <div className='flex flex-col space-y-2 w-full'>
            <label htmlFor="first_name" className="text-xl font-medium text-slate-700">Commentaire</label>
            <textarea id="message" class="block p-2.5 w-full h-[20rem] text-lg text-slate-700 rounded-lg border border-slate-700 focus:outline-none placeholder:text-slate-700 placeholder:text-sm" placeholder="ecris les commentaires ici..."></textarea>
            </div>
        </div>
