...
const CreerConsoleSecretaire = ({closeModal}) => {
  return (
        ...
        <span className='flex justify-center text-3xl font-bold text-slate-700 mt-5'>Creez un console</span>
        <div className='w-[78%] flex flex-col space-y-3 mx-auto'>
            <div className='flex flex-col space-y-2 w-full'>
            <label htmlFor="first_name" className="text-xl font-medium text-slate-700">Numero Du Console</label>
            ...
            <textarea id="message" class="block p-2.5 w-full h-[28rem] text-lg text-slate-700 rounded-lg border border-slate-700 focus:outline-none placeholder:text-slate-700 placeholder:text-sm" placeholder="ecris les commentaires ici..."></textarea>
            </div>
        </div>
