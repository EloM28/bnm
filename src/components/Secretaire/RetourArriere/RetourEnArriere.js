...
const RetourEnArriere = ({closeModal}) => {
  return (
    <div className='mx-auto w-[100%] h-screen flex items-center bg-slate-700 bg-opacity-25 justify-center'>
    <div className='w-[30%] h-[98%] relative flex flex-col space-y-2 bg-white rounded-md rounded-tr-2xl'>
      ...
      <span className='flex justify-center text-3xl font-bold text-slate-700 mt-5'>Retour en arriere dossier</span>
      <div className='w-[78%] flex flex-col space-y-3 mx-auto'>
        ...
        <div className='flex flex-col space-y-2 w-full'>
          ...
          <textarea id="message" class="block p-2.5 w-full h-[6.5rem] text-lg text-slate-700 rounded-lg border border-slate-700 focus:outline-none placeholder:text-slate-700 placeholder:text-sm" placeholder="ecris les commentaires ici..."></textarea>
          </div>
      </div>
...
export default RetourEnArriere
