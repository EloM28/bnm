...
const CreerUrgenceSecretaire = ({closeModal}) => {
  return (
            <div className='mx-auto w-[100%] h-screen flex items-center bg-slate-700 bg-opacity-25 justify-center'>
                ...
                <span className='flex justify-center text-3xl font-bold text-slate-700 mt-5'>Creez une urgence</span>
                <div className='w-[78%] flex flex-col space-y-3 mx-auto'>
                    ...
                    <div className='flex flex-col space-y-2 w-full'>
                    <label htmlFor="first_name" className="text-xl font-medium text-slate-700">Numero D'urgence</label>
