...
const Header = () => {
  ...
  return (
    <div className='relative h-full md:h-[40%] lg:h-[35%]  w-[100%] flex flex-col space-y-[0.5rem] md:space-y-[1.6rem] lg:space-y-[0.5rem]'>
      ...
      <div className='w-full h-full flex flex-col space-y-2 md:space-y-3'>
        <span className='text-slate-700 font-bold text-xl md:text-2xl ml-6'>Historique</span>
        <div className='w-[100%] h-auto sm:h-[28rem] lg:h-[12rem] grid grid grid-cols-1 sm:grid-cols-2 gap-3 md:grid-cols-2 lg:grid-cols-5 place-items-center'>
          <div className='w-full h-[7rem] sm:w-[15rem] sm:h-[6.5rem] md:w-[18rem] md:h-[8.5rem] bg-white shadow-sm shadow-slate-700   rounded-md flex flex-col justify-center gap-y-1 md:gap-y-4 overflow-hidden text-ellipsis'>
            <span className='w-full h-[18.5%]  flex justify-center text-slate-700 text-md md:text-lg font-bold'>Tous les clients</span>
            <div className='p-1 w-[100%] max-h-[75%] md:max-h-[69%] text-justify mx-auto whitespace-normal line-clamp-4 overflow-hidden'>
              <span className='flex justify-center text-slate-700 text-sm md:text-lg font-semibold'>{client}</span>
            </div>
          </div>
          <div className='w-full h-[7rem] sm:w-[15rem] sm:h-[6.5rem] md:w-[18rem] md:h-[8.5rem] bg-white shadow-sm shadow-slate-700   rounded-md flex flex-col justify-center gap-y-1 md:gap-y-4 overflow-hidden text-ellipsis'>
            <span className='w-full h-[18.5%]  flex justify-center text-slate-700 text-md md:text-lg font-bold'>Tous les dossiers</span>
            <div className='p-1 w-[100%] max-h-[75%] md:max-h-[69%] text-justify mx-auto whitespace-normal line-clamp-4 overflow-hidden'>
              <span className='flex justify-center text-slate-700 text-sm md:text-lg font-semibold'>{dossier}</span>
            </div>
          </div>
          <div className='w-full h-[7rem] sm:w-[15rem] sm:h-[6.5rem] md:w-[18rem] md:h-[8.5rem] bg-white shadow-sm shadow-slate-700   rounded-md flex flex-col justify-center gap-y-1 md:gap-y-4 overflow-hidden text-ellipsis'>
            <span className='w-full h-[18.5%]  flex justify-center text-slate-700 text-md md:text-lg font-bold'>Dossiers Standard</span>
            <div className='p-1 w-[100%] max-h-[75%] md:max-h-[69%] text-justify mx-auto whitespace-normal line-clamp-4 overflow-hidden'>
              <span className='flex justify-center text-slate-700 text-sm md:text-lg font-semibold'>{standard}</span>
            </div>
          </div>
          <div className='w-full h-[7rem] sm:w-[15rem] sm:h-[6.5rem] md:w-[18rem] md:h-[8.5rem] bg-white shadow-sm shadow-slate-700   rounded-md flex flex-col justify-center gap-y-1 md:gap-y-4 overflow-hidden text-ellipsis'>
            <span className='w-full h-[18.5%]  flex justify-center text-slate-700 text-md md:text-lg font-bold'>Rapport</span>
            <div className='p-1 w-[100%] max-h-[75%] md:max-h-[69%] text-justify mx-auto whitespace-normal line-clamp-4 overflow-hidden'>
              <span className='flex justify-center text-slate-700 text-sm md:text-lg font-semibold'>{report}</span>
            </div>
          </div>
        </div>
      </div>
      <div className='w-[100%] md:w-[97%] h-8 md:h-10 mx-auto'>
        <div className='w-full h-full flex justify-between'>
          <form className="h-full w-[10rem] md:w-[14.5rem]">
            <select id="categories" className="rounded-md block w-full h-full p-2.5 bg-gray-700 dark:placeholder-gray-400 dark:text-white">
