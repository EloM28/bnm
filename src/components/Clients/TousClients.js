                    ...
                    <div className="">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-neutral-700">
                            <tr className='border-b border-slate-700'>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap font-semibold text-md text-slate-700">NDUWIMANA</td>
                                <td className="px-6 py-4 whitespace-nowrap font-semibold text-md text-slate-700">nduwi@gmail.com</td>
                                <td className="px-6 py-4 whitespace-nowrap font-semibold text-md text-slate-700">69100783</td>
                                <td className="px-6 py-4 whitespace-nowrap font-semibold text-md text-slate-700">10</td>
