...
const PourDossierAvancer = ({closeModal}) => {
  return (
      ...
      <div className='w-[30%] h-[98%] relative flex flex-col space-y-2 bg-white rounded-md rounded-tr-2xl'>
        ...
        <span className='flex justify-center text-3xl font-bold text-slate-700 mt-5'>Avancez un dossier</span>
...
export default PourDossierAvancer
